...
namespace Sprint0
{
    public class ProjectilePlayerSpecialArrow : IProjectile, IBoxCollider
    {
        ...
        public ProjectilePlayerSpecialArrow(Texture2D texture, SpriteBatch batch, Vector2 position, Vector2 direction)
        {
            ...
            bottomRight = new BottomRight((int)position.X + 20, (int)position.Y + 20, this);
