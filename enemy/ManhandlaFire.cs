...
namespace Sprint0.enemy
{
    ...
    class ManhandlaFire: IProjectile, IBoxCollider
    {
        ...
        public ManhandlaFire(Texture2D texture, SpriteBatch batch, Vector2 projectilePos, Vector2 direction, Vector2 destination, int projectileFrame, int frameCount, Vector2 currentPos, Boolean isalive,Player player)
