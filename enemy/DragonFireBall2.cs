...
namespace Sprint0.enemy
{
    ...
    class DragonFireBall2 : IProjectile, IBoxCollider
    {
        ...
        public DragonFireBall2(Texture2D texture, SpriteBatch batch, Vector2 projectilePos, Vector2 direction, Vector2 destination, int projectileFrame, int frameCount, Vector2 currentPos)
...

        {
            ...
            {
                projectilePos.X = Direction.X-35;
                projectilePos.Y = Direction.Y+12;
                isRunning = true;
            }
